...
class BonLaboController extends Controller
{
    ...
    {
        return view('secretaire.bonlabo.index', ['bonlabos' => BonLabo::all()]);
    }
    ...
    {
        return view('secretaire.bonlabo.form', ['bonlabo' => new BonLabo(), 'examens' => Examen::all(), 'patients' => Patient::all(), 'docteurs' => Docteur::all()]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('secretaire.bonlabos.index')->with('success', 'bonlabo ajoutée avec succès !');
    }
    ...
    public function show($id)
    {
        ...
        return view('secretaire.bonlabo.show', compact('bonlabo'));
    }
    /**
    ...
    {
        return view('secretaire.bonlabo.form', [
            'bonlabo' => $bonlabo,
            'examens' => Examen::all(),
    ...
    public function update(Request $request, BonLabo $bonlabo)
    {
        ...
        return redirect()->route('secretaire.bonlabos.index')->with('success', 'bonlabo modifiée avec succès !');
    }
